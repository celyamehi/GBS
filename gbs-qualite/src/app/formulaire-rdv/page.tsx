...
// Configuration Supabase directement dans la page
const supabase = createClient(
  process.env.NEXT_PUBLIC_SUPABASE_URL || '',
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || ''
)

// Types locaux pour éviter les imports
interface Agent {
  id: string
  nom: string
  code_agent: string
...
interface EcouteData {
  ...
  criteres: Record<string, any> | null
}

export default function FormulaireRdvPage() {
